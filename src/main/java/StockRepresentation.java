...
public class StockRepresentation {
  ...
  public StockRepresentation(String handle, String title, String vendor, String type, String tags, String published,
                             String variantSKU, String variantInventoryTracker, String VariantInventoryQty,
                             String variantInventoryPolicy, String variantFulfillmentService,
                             ...
                             String googleShoppingCondition, String googleShoppingCustomProduct,
                             String status) {
    ...
    VariantWeightUnit = "";
    Status = status;
    this.BodyHTML = String.format("<h2><i>%s</i></h2>", handle);
    this.Option2Name = "";
    this.Option2Value = "";
    this.Option3Name = "";
    this.Option3Value = "";
  ...
  public static StockRepresentation fromPartialLine(List<String> token) {
    final String handleTypePrice = String.format(
          "%s=%s=%s",
          Optional.ofNullable(token.get(0)).orElse(""),
          Optional.ofNullable(token.get(2)).orElse(""),
          Optional.ofNullable(token.get(5)).orElse("")
    );
    return new StockRepresentation(
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(0)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(1)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(2)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(3)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(4)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(5)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(6)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(7)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(8)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(9)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(10)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(11)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(12)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(13)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(14)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(15)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(16)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(17)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(18)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(19)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(20)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(21)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(22)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(23)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(24)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(25)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(26)),
        normalizeThenReturn(handleTypePrice, token, getObjectIndex(27))
    );
  }
